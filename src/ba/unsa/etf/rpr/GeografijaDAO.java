...
public class GeografijaDAO {
    ...
    public GeografijaDAO() {
        ...
        try {
            ...
            Grad pariz = new Grad();
            pariz.setNaziv("Pariz"); pariz.setBrojStanovnika(2200000);
            ...
            london.setNaziv("London"); london.setBrojStanovnika(8136000);
            ...
            Grad bec = new Grad();
            bec.setNaziv("Beč"); bec.setBrojStanovnika(1867000);
